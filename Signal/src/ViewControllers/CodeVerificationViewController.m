...
- (void)createViews
{
    ...
    titleLabel.text = NSLocalizedString(@"VERIFICATION_HEADER",
    ...
    [_challengeButton setTitle:NSLocalizedString(@"VERIFICATION_CHALLENGE_SUBMIT_CODE",
                      ...
                      forState:UIControlStateNormal];
    [_challengeButton setTitleColor:[UIColor whiteColor] forState:UIControlStateNormal];
    ...
    [_challengeButton autoPinEdge:ALEdgeTop toEdge:ALEdgeBottom ofView:underscoreView withOffset:15];
    ...
    [_sendCodeViaSMSAgainButton autoPinEdge:ALEdgeTop toEdge:ALEdgeBottom ofView:_challengeButton withOffset:10];
                ...
                replacementString:(NSString *)insertionText
{
    ...
    NSString *formattedNewText
        = (rawNewText.length <= 3 ? rawNewText : [[[rawNewText substringToIndex:3] stringByAppendingString:@"-"]
