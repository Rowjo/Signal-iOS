...
+ (OWSTableSection *)sectionWithTitle:(NSString *)title items:(NSArray *)items
{
        ...
        addSection:[OWSTableSection
                       sectionWithTitle:@"Messages View"
                                  items:@[
                                      ...
                                      [OWSTableItem
                                          actionWithTitle:@"Send unknown mimetype"
                                              actionBlock:^{
...
+ (void)sendRandomAttachment:(TSThread *)thread uti:(NSString *)uti
{
    ...
    SignalAttachment *attachment =
        [SignalAttachment genericAttachmentWithData:[self createRandomNSDataOfSize:256] dataUTI:uti];
    [ThreadUtil sendMessageWithAttachment:attachment inThread:thread messageSender:messageSender];
}
