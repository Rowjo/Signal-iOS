...
- (void)loadView
{
    ...
    self.enableCallKitCell.textLabel.text
        = NSLocalizedString(@"SETTINGS_PRIVACY_CALLKIT_TITLE", @"Short table cell label");
    ...
    self.enableCallKitPrivacyCell.textLabel.text
        = NSLocalizedString(@"SETTINGS_PRIVACY_CALLKIT_PRIVACY_TITLE", @"Label for 'CallKit privacy' preference");
